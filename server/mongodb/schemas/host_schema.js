...
const host_schema = new mongoose.Schema({
    ...
    canHostSmallPet: {type: Boolean, default: true},
    canHostMediumPet: {type: Boolean, default: true},
    canHostLargePet: {type: Boolean, default: true},
    canHostGiantPet: {type: Boolean, default: true},
